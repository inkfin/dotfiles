...
> 本文件是 canonical 副本，改动从这里出。

---

## Specialist lanes

You have specialist subagents. Delegate by lane, never do a lane's work inline when it is mechanical:
...
2. **Background by default.** Dispatch specialists with background tasks and continue coordinating; wait on results at the point their output is needed, not earlier.
